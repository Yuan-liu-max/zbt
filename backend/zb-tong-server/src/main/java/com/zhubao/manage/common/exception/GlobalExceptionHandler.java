...
public class GlobalExceptionHandler {
    ...
    public ApiResult<Void> handleMethodArgumentNotValid(MethodArgumentNotValidException e) {
        ...
        log.warn("参数校验失败: {}", msg);
        return ApiResult.invalidParam(msg);
    }
    ...
    public ApiResult<Void> handleMissingParam(MissingServletRequestParameterException e) {
        ...
        return ApiResult.invalidParam("缺少请求参数: " + e.getParameterName());
    }
    ...
    public ApiResult<Void> handleMessageNotReadable(HttpMessageNotReadableException e) {
        ...
        return ApiResult.invalidParam("请求体格式错误");
    }
    ...
    public ApiResult<Void> handleMethodNotSupported(HttpRequestMethodNotSupportedException e) {
        ...
        return ApiResult.fail(405, "不支持的请求方法: " + e.getMethod());
    }
    ...
    public ApiResult<Void> handleMediaTypeNotSupported(HttpMediaTypeNotSupportedException e) {
        ...
        return ApiResult.fail(415, "不支持的Content-Type");
    }
    ...
    public ApiResult<Void> handleIllegalArgument(IllegalArgumentException e) {
        ...
        return ApiResult.invalidParam(e.getMessage());
    }
    ...
    public ApiResult<Void> handleException(Exception e) {
        log.error("系统异常", e);
        return ApiResult.fail(ErrorCode.INTERNAL_ERROR.getCode(), "系统内部异常，请联系管理员");
    }
}
