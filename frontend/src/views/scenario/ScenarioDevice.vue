        ...
        <a-form layout="inline" :model="searchForm" @finish="handleSearch">
          <a-form-item label="门店">
            ...
            >
              ...
              <a-select-option value="银泰百货店">银泰百货店</a-select-option>
...
import type { DeviceItem, SceneQueryParams, SceneStatus } from '@/types/scenario'
import { deviceApi, statusMap } from '@/api/mock/scenario'
...
// 表格列配置
const columns = [
  { title: '检查编号', dataIndex: 'code', key: 'code', width: 160 },
  { title: '门店', dataIndex: 'store', key: 'store', width: 140 },
  { title: '设备类型', dataIndex: 'deviceType', key: 'deviceType', width: 120 },
  { title: '检查日期', dataIndex: 'checkDate', key: 'checkDate', width: 170 },
  { title: '检查人', dataIndex: 'checker', key: 'checker', width: 90 },
...
const handleView = (record: DeviceItem) => {
  message.info(`查看设备检查: ${record.code}`)
}

// 详情
const handleDetail = (record: DeviceItem) => {
  message.info(`查看详情: ${record.code}`)
}
